...
This document records a future adapter expansion point only. It must not be treated as support for Fabric.
...
2. Review official Fabric documentation and official examples or templates.
