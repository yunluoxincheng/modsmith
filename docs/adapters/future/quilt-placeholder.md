...
|---|---|
| Loader | `quilt` |
| Status | Optional / later placeholder |
| Production ready | No |
...
This document records a future adapter expansion point only. It must not be treated as support for Quilt.
...
2. Review official Quilt documentation and official examples or templates.
